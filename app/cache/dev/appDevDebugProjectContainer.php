...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_1' => 'get5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e131Service',
            '5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_2' => 'get5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e132Service',
            '5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_3' => 'get5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e133Service',
            '5ea4f98e3f392ee9f15b61d290e294d03a3ddfddfc06e57b91b22afeb5727d08_1' => 'get5ea4f98e3f392ee9f15b61d290e294d03a3ddfddfc06e57b91b22afeb5727d081Service',
    ...
    /**
     * Gets the '5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_1' service.
     *
     ...
     */
    protected function get5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e131Service()
    {
        return $this->services['5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e132Service()
    {
        return $this->services['5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e133Service()
    {
        return $this->services['5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }

    /**
     * Gets the '5ea4f98e3f392ee9f15b61d290e294d03a3ddfddfc06e57b91b22afeb5727d08_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get5ea4f98e3f392ee9f15b61d290e294d03a3ddfddfc06e57b91b22afeb5727d081Service()
    {
        return $this->services['5ea4f98e3f392ee9f15b61d290e294d03a3ddfddfc06e57b91b22afeb5727d08_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symblog', 'user' => 'daniel', 'password' => 12345, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('5ea4f98e3f392ee9f15b61d290e294d03a3ddfddfc06e57b91b22afeb5727d08_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'Blogger\\BlogBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/adicionar');
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.main'), 1 => $i), 'secured_area', $a, $c), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'secured_area', $l, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $j, array('login_path' => 'login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '53c7e6365a37d', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, 'login', false), NULL, NULL, $a));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_1'), 1 => $this->get('5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_2'), 2 => $this->get('5700214cec219bc01c7c9115971cf89b2393606b98a1021e38c2f4acf8e07e13_3')));
        $a->setUsername('your_username');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('security.validator.user_password' => 'security.validator.user_password', 'validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique')));
        $instance->setTranslator($this->get('translator'));
        $instance->setTranslationDomain('validators');
        $instance->addXmlMappings(array(0 => '/var/www/symblog/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
        $instance->addYamlMappings(array(0 => '/var/www/symblog/src/Blogger/BlogBundle/Resources/config/validation.yml'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'your_username',
